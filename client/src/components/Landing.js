...
function Landing() {
  ...
  return (
    <div>
      <div className="inputs"><h1 style={{ color: randomColor1 }}>S</h1><h1 style={{ color: randomColor2 }}>T</h1><h1 style={{ color: randomColor3 }}>U</h1><h1 style={{ color: randomColor4 }}>D</h1><h1  style={{ color: randomColor5 }}>I</h1><h1 style={{ color: randomColor6 }}>O</h1></div>
