...
function Post({authUser, posts, setPosts}) {
    ...
    <div className="right profile-box center">
            ...
            { authUser.discipline_id === 4 ? <div>
                <form>
                    <input className="center" onChange={handleHeading} type="text" name="heading" placeholder="heading" value={heading}></input><br></br>
                    <textarea className="center" onChange={handleBlog} type="text" name="blog" placeholder="blog content" value={blog} rows="20" cols="50"></textarea><br></br>
            ...
            <div>
                <form>
                    ...
                    <input className="center" onChange={handleText} type="text" name="content" placeholder="upload details" value={text}></input><br></br>
